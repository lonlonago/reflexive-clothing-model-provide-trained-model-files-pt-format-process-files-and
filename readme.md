# Reflexive clothing model provide trained model files (pt format) process files and validation

# Body

Reflexive clothing model, provide the trained model file (pt format), process file and validation image
Provide the corresponding training dataset of 8800 pieces, suitable for learning research and graduation projects
The model and dataset can be sold separately
